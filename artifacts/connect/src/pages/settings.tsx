    ...
    },
    {
      ...
      items: [
        { icon: Smartphone, title: "Connected Devices", desc: "Manage active sessions", path: "/settings/devices" },
        {
          icon: Clock,
          title: "Auto Logout",
          desc: "Shared computer protection",
          path: "/settings/auto-logout",
      ...
      <div className="p-4 pb-10 space-y-6">
              ...
              {section.items.map((item, itemIdx) => {
                ...
                return (
                  <Link
                    key={itemIdx}
                    href={item.path}
                    className={`flex items-center p-4 hover:bg-white/5 transition-colors ${itemIdx !== section.items.length - 1 ? "border-b border-white/5" : ""}`}
                  >
                    ...
                    <div className="flex items-center gap-2">
                      {item.value && (
                        <span className="text-xs font-medium text-primary bg-primary/10 px-2 py-1 rounded-md">{item.value}</span>
                      )}
        ...
        <div className="mt-8">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 p-4 rounded-2xl text-destructive hover:bg-destructive/10 transition-colors font-medium"
          >
